...
let dialogbox = (message) => {// Get the modal
    ...
    let modal = document.querySelector('#dialogbox');

    let divMsg = document.querySelector('.dialog-content-js');
...
const closeNav = () => {
  ...
  const createTrip = () =>{
    //document.querySelector('.modal').style.display="block";
      document.querySelector('.modal-new-trip').style.display="block";
  }
